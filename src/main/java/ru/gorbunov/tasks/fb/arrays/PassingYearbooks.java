...
public class PassingYearbooks {
    ...
    public static void main(String[] args) {
        int[] nums1 = {2, 1};
        int[] nums2 = {1, 2};
        System.out.println(Arrays.toString(new PassingYearbooks().findSignatureCounts(nums1)));
        System.out.println(Arrays.toString(new PassingYearbooks().findSignatureCounts(nums2)));
//        System.out.println(Arrays.toString(new PassingYearbooks().fastFindSignatureCounts(nums1)));
//        System.out.println(Arrays.toString(new PassingYearbooks().fastFindSignatureCounts(nums2)));
    }
